...
#[\Symfony\Component\Routing\Attribute\Route(path: '/front/preference')]
class PreferenceEmailController extends AbstractController
{
    ...
    #[\Symfony\Component\Routing\Attribute\Route(path: '/edit', name: 'grr_front_preference_email_edit', methods: ['GET', 'POST'])]
